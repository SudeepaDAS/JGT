...
export default function Dashboard() {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold text-MidnightBlue mb-6">Dashboard</h2>
      ...
      <div className="mt-8 bg-white p-6 rounded-lg shadow">
        ...
        <form className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <input
            ...
            className="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-MidnightBlue"
          />
          <input
            type="number"
            ...
            className="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-MidnightBlue"
          />
          <button className="bg-MidnightBlue text-gray-700 px-4 py-2 rounded-md hover:bg-green-700 transition">
            Add Product
          </button>
        </form>
      </div>
